...
await suite("parseGitTree", async () => {
    ...
    await it("parses 1", () => {
        const actual = [
            ...parseGitTree(Buffer.from("040000 tree 1a49874763efc06e3b7bdef3a2a98fa460db03fb\tsrc\0")),
        ];
    ...
    await it("parses 2", () => {
        const actual = [
            ...parseGitTree(Buffer.from("040000 tree 1a49874763efc06e3b7bdef3a2a98fa460db03fb\tnew\nline\0" +
    ...
    await it("fails on missing TAB", () => {
        const line1 = "040000 tree 1a49874763efc06e3b7bdef3a2a98fa460db03fb\tsrc1\0";
